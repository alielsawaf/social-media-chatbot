...
FAQ = {
    ...
    "هل يوجد توصيل": "خدمة توصيل أبو السيد متاحة الآن في مدينتي اربيسك  والتجمع الأول  و التجمع الخامس و التجمع الثالث و ويست جيت أكتوبر فقط. 
للطلبات خارج هذا المناطق، نوفر لك سائقًا خاصًا لكن برسوم توصيل إضافية.
خدمه التوصيل متوفره فى بورسعيد و القاهره و اسكندريه والغردقه فقط

لا يوجد توصيل من اي (بارتيشن)
لا يوجد رقم تواصل مع اي (بارتيشن)
لا يوجد توصيل من منفذ المصنع فى بورسعيد 
."
}
